...
output "vm_id" {
  description = "The ID of the Red Hat Virtual Machine"
...
output "vm_size" {
  description = "The size of the Red Hat Virtual Machine"
  value       = azurerm_linux_virtual_machine.vm.size
}

# Network Information
output "private_ip_address" {
  description = "The private IP address of the Red Hat Virtual Machine"
  value       = azurerm_linux_virtual_machine.vm.private_ip_address
}

output "public_ip_address" {
  description = "The public IP address of the Red Hat Virtual Machine"
  value       = azurerm_linux_virtual_machine.vm.public_ip_address
}

output "network_interface_ids" {
  description = "The network interface IDs attached to the Red Hat Virtual Machine"
  value       = azurerm_linux_virtual_machine.vm.network_interface_ids
}

# OS and Image Information
output "os_disk" {
  description = "The OS disk configuration of the Red Hat Virtual Machine"
  value = {
...
output "source_image_reference" {
  description = "The source image reference used for the Red Hat Virtual Machine"
  value = {
...
output "admin_username" {
  description = "The admin username for the Red Hat Virtual Machine"
  value       = azurerm_linux_virtual_machine.vm.admin_username
}

# Location and Resource Group
output "location" {
  description = "The location where the Red Hat Virtual Machine is deployed"
  value       = azurerm_linux_virtual_machine.vm.location
}

output "resource_group_name" {
  description = "The resource group name where the Red Hat Virtual Machine is deployed"
  value       = azurerm_linux_virtual_machine.vm.resource_group_name
}

# Additional Useful Information
output "tags" {
  description = "The tags assigned to the Red Hat Virtual Machine"
  value       = azurerm_linux_virtual_machine.vm.tags
}

output "vm_computer_name" {
  description = "The computer name of the Red Hat Virtual Machine"
  value       = azurerm_linux_virtual_machine.vm.computer_name
}

# Connection Information
output "ssh_connection_command" {
  description = "SSH connection command for the Red Hat Virtual Machine"
